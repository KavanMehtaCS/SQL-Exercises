...
/* Get All Bands that do not have Albums */
SELECT DISTINCT bands.name AS 'Band Name' FROM bands
...
/* Insert a record for my favorite band and albums */
INSERT INTO bands(id, name) VALUES (8, 'One Direction');
INSERT INTO albums(name, release_year, band_id) VALUES ('Up All Night', 2011, 8);

/* Delete the record of my favorite band and albums */
...
SELECT bands.name AS Band, COUNT(songs.length) as 'Number of Songs'
FROM bands
